...
<div class="container user-con">
	<div class="row justify-content-center user-style">
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">홈페이지 이용약관</div>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다."
				...
				<div style="text-align: right;">
					<input type="checkbox" name="check" id="check">이용약관에 동의 합니다.
				</div>
				<div class="msg" id="checkMsg">회원 가입을 원하시는 경우 이용약관에 동의하셔야 합니다.</div>
				<div class="form-group ">
                	<button type="button" class="btn btn-primary btn-lg btn-block user-btn" id="checkBtn">회원가입</button>
                </div> 
			</div>
 		</div>
    </div>	
