 ...
 <ul>
  ...
  <div class="shop-detail-box-main">
        ...
        <div style="text-align: center;">
            ...
            <div class="row" >
                  <div class="col-xl-5 col-lg-5 col-md-6" style="flex: 100%; max-width: 100%; padding-top: 50px;">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src=<c:url value="bluemoon/images/hotel_img/room-1.jpg"/> alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src=<c:url value="bluemoon/images/hotel_img/room-1.jpg"/> alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src=<c:url value="bluemoon/images/hotel_img/room-1.jpg"/> alt="Third slide"> </div>
                        </div>
                        ...
                        <ol class="carousel-indicators" style="padding-top: 10px; background-color: white;">
                            <li data-target="#carousel-example-1" data-slide-to="0" class="active">
                                <img class="d-block w-100 img-fluid" src=<c:url value="bluemoon/images/hotel_img/room-1.jpg"/> alt="" />
                            </li>
                ...
                <div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			...
          			<div class="fields">
			              ...
			              <div class="col-md-6">
			                    ...
			                    <select name="" id="" class="form-control" placeholder="인원선택">
			              ...
			              <div class="col-md-6">
				              <div class="form-group">
				                <input type="text" class="form-control" placeholder="예약자 이름">
				              </div>
			              </div>
			              <div class="col-md-6">
				              <div class="form-group">
