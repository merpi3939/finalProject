...
<title>BlueMoon</title>
    ...
    <link rel="stylesheet" href=<c:url value="bluemoon/css/open-iconic-bootstrap.min.css"/>>
    ...
    <link rel="stylesheet" href=<c:url value="bluemoon/css/ionicons.min.css"/>>
    ...
    <link rel="stylesheet" href=<c:url value="bluemoon/css/icomoon.css"/>>
...
<body>
	...
	<script src=<c:url value="bluemoon/js/jquery.timepicker.min.js"/>></script>
	<script src=<c:url value="bluemoon/js/scrollax.min.js"/>></script>
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
	<script src=<c:url value="bluemoon/js/google-map.js"/>></script>
