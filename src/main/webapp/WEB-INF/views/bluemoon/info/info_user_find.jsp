    	...
    	<table class="table table-striped" style="margin-bottom: 50px;">
 			<thead>
   				<tr>
  					...
  					<th width="100">사진</th>
  					<th width="200">분실물 이름</th>
  					<th width="200">분실장소</th>
  					<th width="100">분실날짜</th>
				</tr>
 			</thead>
 		<tbody>   	
   			<tr>
      			<td>1</td>
      			<td><img alt="img" src="" width="90" height="90"></td>
      			<td><a class="table-a" href="#">찾아가쇼</a></td>
			    <td>어딘가</td>
			    <td>2020-01-01</td>
   			</tr>
		 </tbody> 
