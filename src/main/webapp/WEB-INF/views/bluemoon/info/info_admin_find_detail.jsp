...
<div class="container">
	<div class="row" style="margin-top: 50px">
		<div class="col-md-12">
			<ul class="nav nav-tabs nav-justified navbar-nav">
				...
				<li class="nav-item">
					<a class="nav-link info-page" href="#">습득물 관리</a>
				</li>
				<li class="nav-item">
	...
	<div class="board-border">
		<table class="board-frame findTable">
			...
			<tr>
				<td class="inputName">습득 날짜</td>
				<td class="inputTd" ><input type="text" class="input" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="inputName">보관장소</td>
				<td class="inputTd"><input type="text" class="input" readonly="readonly"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="inputTd"><textarea class="form-control" rows="15" readonly="readonly"></textarea></td>
			</tr>
		</table>
