...
<!-- Area Chart script -->
<script src="<%=request.getContextPath() %>/admin/home/home_area_data.js"></script>

<!-- Table Chart script -->

<!--DataTables [ OPTIONAL ]-->
<script src="<%=request.getContextPath() %>/admin/plugins/datatables/media/js/jquery.dataTables.js"></script>
<script src="<%=request.getContextPath() %>/admin/plugins/datatables/media/js/dataTables.bootstrap.js"></script>
<script src="<%=request.getContextPath() %>/admin/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>

<!--DataTables Sample [ SAMPLE ]-->
<script src="<%=request.getContextPath() %>/admin/js/demo/tables-datatables.js"></script>
